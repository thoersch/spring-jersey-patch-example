...
import com.thoersch.examples.ApplicationConfiguration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.thoersch.examples.persistence", repositoryFactoryBeanClass = JpaRepositoryFactoryBean.class)
public class SqlInitialization {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.thoersch.examples.representations");
